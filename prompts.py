...
{{
  ...
  "naver_content": "네이버 블로그 독자를 위한 스토리텔링 중심의 가독성 높은 마크다운 원고",
  "tistory_content": "티스토리 블로그 독자를 위한 기술적 깊이와 객관적 팩트 분석 중심의 마크다운 원고",
  "wordpress_content": "워드프레스 독자 및 구글 검색 노출(SEO)을 위한 체계적인 계층 구조(H2/H3) 중심의 마크다운 원고"
}}
